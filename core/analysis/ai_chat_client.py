...
class AIChatClient:
    ...
    def _init_claude_client(self):
        ...
        try:
            ...
            if self.api_key:
                ...
                logger.warning("⚠️ 未找到Claude API密钥")
    ...
    def _init_deepseek_client(self):
        ...
        try:
            ...
            if self.api_key:
                ...
                logger.warning("⚠️ 未找到DeepSeek API密钥")
    ...
    def chat(self, message: str, system_prompt: Optional[str] = None, 
        ...
        try:
            ...
            if self.backend == "openai" or self.backend == "deepseek":
                return self._chat_openai_style(message, system_prompt, temperature, max_tokens)
            elif self.backend == "claude":
                return self._chat_claude_style(message, system_prompt, temperature, max_tokens)
            else:
                return self._simulate_response(message)
    ...
    def _chat_openai_style(self, message: str, system_prompt: Optional[str], 
    ...
    def _chat_claude_style(self, message: str, system_prompt: Optional[str], 
                          temperature: float, max_tokens: int) -> str:
        """Claude风格的聊天"""
        try:
            kwargs = {
